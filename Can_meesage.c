...
void CanSend(void)
{
    ...
    if(flagSEND==1)
    {
        ...
        for(i=0; i < Send_sum; i++)
        {
            ...
            ECanaMboxes.MBOX25.MDL.byte.BYTE0=TXBUF[0+i*8];
            ECanaMboxes.MBOX25.MDL.byte.BYTE1=TXBUF[1+i*8];
            ECanaMboxes.MBOX25.MDL.byte.BYTE2=TXBUF[2+i*8];
            ECanaMboxes.MBOX25.MDL.byte.BYTE3=TXBUF[3+i*8];
            ECanaMboxes.MBOX25.MDH.byte.BYTE4=TXBUF[4+i*8];
            ECanaMboxes.MBOX25.MDH.byte.BYTE5=TXBUF[5+i*8];
            ECanaMboxes.MBOX25.MDH.byte.BYTE6=TXBUF[6+i*8];
            ECanaMboxes.MBOX25.MDH.byte.BYTE7=TXBUF[7+i*8];
...
void CanRecieve(void)
{
    ...
    if(TestMbox1==0xfefefefe)
    {
        ...
        Rxdata[0]=ECanaMboxes.MBOX16.MDL.byte.BYTE0;
        Rxdata[1]=ECanaMboxes.MBOX16.MDL.byte.BYTE1;
        Rxdata[2]=ECanaMboxes.MBOX16.MDL.byte.BYTE2;
        Rxdata[3]=ECanaMboxes.MBOX16.MDL.byte.BYTE3;

        //头一包数据分析
        Rxdata[4]=ECanaMboxes.MBOX16.MDH.byte.BYTE4;
        ...
        Rxdata[5]=ECanaMboxes.MBOX16.MDH.byte.BYTE5;
        Rxdata[6]=ECanaMboxes.MBOX16.MDH.byte.BYTE6;
        Rxdata[7]=ECanaMboxes.MBOX16.MDH.byte.BYTE7;

    }
    else
    {
        //第二包及之后数据处理
        Rxdata[0+cnt*8]=ECanaMboxes.MBOX16.MDL.byte.BYTE0;
        Rxdata[1+cnt*8]=ECanaMboxes.MBOX16.MDL.byte.BYTE1;
        Rxdata[2+cnt*8]=ECanaMboxes.MBOX16.MDL.byte.BYTE2;
        Rxdata[3+cnt*8]=ECanaMboxes.MBOX16.MDL.byte.BYTE3;

        Rxdata[4+cnt*8]=ECanaMboxes.MBOX16.MDH.byte.BYTE4;
        Rxdata[5+cnt*8]=ECanaMboxes.MBOX16.MDH.byte.BYTE5;
        Rxdata[6+cnt*8]=ECanaMboxes.MBOX16.MDH.byte.BYTE6;
        Rxdata[7+cnt*8]=ECanaMboxes.MBOX16.MDH.byte.BYTE7;
